...
def add_historical_data_first_semester():
    """向数据库添加第一学期历史数据，包括2023-2024-1学期的教师课程和学生选课记录"""
    try:
        # 连接数据库
        ...
        # 设置历史学期
        historical_semester = "2023-2024-1"  # 2023-2024学年第一学期
        
        print(f"添加 {historical_semester} 学期历史数据...")
        
        # 添加班级信息（课程与教师的关联）- 2023-2024第一学期
        class_assignments = [
            (historical_semester, 'CS101', 'T10001', '2023-09-01 08:00:00'),
            (historical_semester, 'CS201', 'T10001', '2023-09-01 10:00:00'),
            (historical_semester, 'CS301', 'T10002', '2023-09-01 14:00:00'),
            (historical_semester, 'EE101', 'T10003', '2023-09-02 08:00:00'),
            (historical_semester, 'EE201', 'T10003', '2023-09-02 10:00:00'),
            (historical_semester, 'MA101', 'T10004', '2023-09-02 14:00:00'),
            (historical_semester, 'MA201', 'T10004', '2023-09-03 08:00:00'),
            (historical_semester, 'PH101', 'T10005', '2023-09-03 10:00:00'),
            (historical_semester, 'EN101', 'T10001', '2023-09-03 14:00:00')
        ]
        ...
        course_selections = [
            ...
            ('S20001', historical_semester, 'PH101', 'T10005'),
            ('S20002', historical_semester, 'CS101', 'T10001'),
            ('S20002', historical_semester, 'CS301', 'T10002'),
            ('S20002', historical_semester, 'MA101', 'T10004'),
            ('S20003', historical_semester, 'EE101', 'T10003'),
            ('S20003', historical_semester, 'MA101', 'T10004'),
            ('S20003', historical_semester, 'EN101', 'T10001'),
            ('S20004', historical_semester, 'MA101', 'T10004'),
            ('S20004', historical_semester, 'CS301', 'T10002'),
            ('S20004', historical_semester, 'CS101', 'T10001'),
            ('S20005', historical_semester, 'EE201', 'T10003'),
            ('S20005', historical_semester, 'EN101', 'T10001'),
            ('S20005', historical_semester, 'MA201', 'T10004')
        ]
...
if __name__ == "__main__":
    add_historical_data_first_semester() 